...
public class Stopwords implements TermPipeline
{
	 ...
	 */
	public Stopwords(final TermPipeline next)
	{
	...
	/** Makes a new stopword term pipeline object. The stopwords file(s)
	  ...
	  */	
	public Stopwords(final TermPipeline next, final String StopwordsFile)
	{
		this.next = next;
	...
	/** Makes a new stopword term pipeline object. The stopwords file(s)
	  ...
	  * @since 1.1.0
	  */
	public Stopwords(final TermPipeline next, final String StopwordsFiles[])
	{
		this.next = next;
