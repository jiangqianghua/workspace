...
public class TRECSetup {
	...
	public static void main(java.lang.String[] args) {
		if (args.length!=2) {
			System.err.println("usage : TRECSetup <install dir> <collection dir>");
		...
		String installDirectory = args[0];
		...
		try {	
			...
			methods.println("#uk.ac.gla.terrier.matching.models.BM25");
			methods.println("#uk.ac.gla.terrier.matching.models.DFR_BM25");
			methods.println("#uk.ac.gla.terrier.matching.models.TF_IDF");
			methods.println("#uk.ac.gla.terrier.matching.models.BB2");
			methods.println("#uk.ac.gla.terrier.matching.models.IFB2");
			methods.println("#uk.ac.gla.terrier.matching.models.In_expB2");
			methods.println("#uk.ac.gla.terrier.matching.models.In_expC2");
			methods.println("#uk.ac.gla.terrier.matching.models.InL2");
			methods.println("#uk.ac.gla.terrier.matching.models.PL2");
			methods.println("#If you enter a not fully-qualified name of a ");
			methods.println("#class, then the default namespace");
			methods.println("#uk.ac.gla.terrier.matching.models is prepended");
			...
			qemethods.println("#uk.ac.gla.terrier.matching.models.queryexpansion.Bo1");
			qemethods.println("#uk.ac.gla.terrier.matching.models.queryexpansion.Bo2");
			qemethods.println("#uk.ac.gla.terrier.matching.models.queryexpansion.KL");
			qemethods.println("#If you enter a not fully-qualified name of a ");
			qemethods.println("#class, then the default namespace");
			qemethods.println("#uk.ac.gla.terrier.matching.models.queryexpansion");
			...
			propertiesWriter.println("#directory names");
			propertiesWriter.println("terrier.home=" + installDirectory);
			...
			propertiesWriter.println("querying.default.controls=c:1.0,start:0,end:999");
			propertiesWriter.println("querying.allowed.controls=c,scope,qe,qemodel,start,end");
			propertiesWriter.println();
			...
			propertiesWriter.println();
			propertiesWriter.println("#create a temporary lexicon after");
			propertiesWriter.println("#indexing bundle.size documents");
			propertiesWriter.println("bundle.size=2500");
			propertiesWriter.println();
