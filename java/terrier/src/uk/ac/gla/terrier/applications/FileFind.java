 ...
 * <pre>java uk.ac.gla.terrier.applications.FileFind c:\</pre>
...
public class FileFind {
	 ...
	 */
	private static void findFiles(LinkedList<String> fileList, LinkedList<String> dirList)
	{
		if (dirList.size() == 0)
			return;
