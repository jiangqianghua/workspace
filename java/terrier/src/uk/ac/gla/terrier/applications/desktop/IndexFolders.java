...
public class IndexFolders extends JDialog {
	...
	private ArrayList folders = null;
	private Vector workingFolders = null;
	 ...
	 */
	public void setFolders(ArrayList v) {
		folders = v;
		workingFolders = new Vector(v);
	}
	 ...
	 * @param v the list of selected folders.
	 */
	public IndexFolders(ArrayList v, JFrame parent) {
		this(parent);
		folders = v;
		workingFolders = new Vector(v);
	}
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {    
					folders = new ArrayList(workingFolders);
					setVisible(false);
				}
			});
		}
	...
	public void renderFolders() {
		jList1.setListData(workingFolders.toArray());
	}
	/**
