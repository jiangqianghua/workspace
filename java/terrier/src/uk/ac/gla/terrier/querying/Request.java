...
public class Request implements SearchRequest
{
	...
	protected Hashtable<String,String> Control = new Hashtable<String,String>();
	...
	public void setControls(Hashtable<String,String> controls)
	{
		Control = controls;
	}
	 ...
	 * @param startedProcessingTime the time obtained from a call
