...
public class SimpleFileCollection implements Collection/*, DocumentExtractor*/
{
	...
	protected LinkedList<String> firstList;

	/** This is filled during traversal, so document IDs can be matched with filenames */
	protected ArrayList<String> indexedFiles = new ArrayList<String>();
	...
	protected Hashtable<String,Class> extension_DocumentClass = new Hashtable<String,Class>();
	 ...
	 */
	public SimpleFileCollection(ArrayList<String> filelist, boolean recurse) {
	...
	public boolean nextDocument()
	{
		...
		while(FileList.size() > 0 && ! rtr)
		{
			...
			{
				logger.warn("File doesn't exist or cannot be read:  "+thisFilename);
				rtr = nextDocument();
			}
