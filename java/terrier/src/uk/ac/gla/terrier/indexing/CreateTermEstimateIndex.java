...
public class CreateTermEstimateIndex {
	...
	/** The file of the TermEstimateIndex. */
	protected File fTermEstimateIndex;
	/**
	...
	public CreateTermEstimateIndex(Index i, String modelName) {
		...
		this.termEstimateIndex = new TermEstimateIndex(i);
		this.fTermEstimateIndex = this.termEstimateIndex.fTermEstimateIndex;
	}
	...
	public void createTermEstimateIndex(){
		...
		try{
			DataOutputStream output = new DataOutputStream(
					Files.writeFileStream(this.fTermEstimateIndex));
