 ...
 * the LookAheadStrea, will stop after reading the string END. Note that the 
 ...
 * for collections of webpages, which may use different encodings.
 * 
 * @author Craig Macdonald, Vassilis Plachouras
 * @version $Revision: 1.7 $
 * @see uk.ac.gla.terrier.utility.LookAheadStream
 */
