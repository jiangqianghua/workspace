...
public class FieldDocumentTreeNode extends TreeNode {
	...
	/**
	 * Constructs a tree node for the given term, if the term code
	 * is already known.
	 * @param newTerm the term
	 * @param givenTermCode the term code to use if it is already known
	 */
	public FieldDocumentTreeNode(String newTerm, int givenTermCode) {
		super(newTerm, givenTermCode);
		fieldScore = new FieldScore();
	}
	 ...
	 */
	public FieldDocumentTreeNode(String newTerm, Set<String> fields) {
		super(newTerm);
		fieldScore = new FieldScore();
		if (fields!=null) 
	 ...
	 */
	public void addToFieldScore(Set<String> fields) {
		fieldScore.insertFields(fields);
	}
	/**
