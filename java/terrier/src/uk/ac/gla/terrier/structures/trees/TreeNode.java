...
public class TreeNode implements Comparable<TreeNode> {
	...
	public int termCode;
	/**
	 * A constructor for a new node. This constructor will obtain a new
	 * term code for the term using the TermCodes class.
	 ...
	 *  @param newTerm the String term for this term.
	 *  @param givenTermCode the term code for this string if already known.
	 */
	public TreeNode(String newTerm, int givenTermCode)
	{
		this.term = newTerm;
		this.termCode = givenTermCode;
	}
	 ...
	 * @param TN1 Object the tree node to compare to.
