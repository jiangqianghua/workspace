 ...
 */
public class BlockDirectIndex extends DirectIndex implements IndexConfigurable {
    ...
    public BlockDirectIndex(DocumentIndex docIndex, String path, String prefix)
    {
        this(
            docIndex,
	...
	protected BlockDirectIndex(){super();}
	protected BlockDirectIndex(long a, long b, long c){super(a,b,c);}
