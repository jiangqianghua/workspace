...
public class StructureMerger {
	...
	protected Class directFileOutputStreamClass = DirectInvertedOutputStream.class;
	/** class to use to write inverted file */
	protected Class invertedFileOutputStreamClass = DirectInvertedOutputStream.class;
