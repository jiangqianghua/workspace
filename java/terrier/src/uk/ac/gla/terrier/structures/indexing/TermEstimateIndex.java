...
public class TermEstimateIndex {
	...
	public File fTermEstimateIndex;
	/**
	...
	public TermEstimateIndex(Index index)
	{
		...
		this.fTermEstimateIndex = new File(INDEX_FILENAME);
		...
		if (this.fTermEstimateIndex.exists()){
			//TerrierTimer timer = new TerrierTimer();
			//timer.start();
			try{
				DataInputStream in = new DataInputStream(
					Files.openFileStream(this.fTermEstimateIndex));
