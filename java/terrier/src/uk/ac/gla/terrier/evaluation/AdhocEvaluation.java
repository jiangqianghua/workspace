...
public class AdhocEvaluation extends Evaluation {
	...
	*/
	...
	public void evaluate(String resultFilename) {
		...
		Vector listOfRetrieved = new Vector();
		Vector listOfRelevantRetrieved = new Vector();
		Vector vecNumberOfRelevant = new Vector();
		Vector vecNumberOfRetrieved = new Vector();
		Vector vecNumberOfRelevantRetrieved = new Vector();
		Vector vecQueryNo = new Vector();
		...
		try {
			...
			Vector relevantRetrieved = new Vector();
			...
			while ((str=br.readLine()) != null) {
				...
				if (!previous.equals(queryid)) {
					if (effQueryCounter != 0) {
						vecNumberOfRetrieved.addElement(new Integer(numberOfRetrievedCounter));
						vecNumberOfRelevantRetrieved.addElement(new Integer(numberOfRelevantRetrievedCounter));
					...
					vecNumberOfRelevant.addElement(new Integer(qrels.getNumberOfRelevant(queryid)));
				}
				previous = queryid;
