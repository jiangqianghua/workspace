...
START %JAVA_BIN% -Xmx120M -Dterrier.home="%TERRIER_HOME%" -Dterrier.etc="%TERRIER_ETC%" -Dterrier.setup="%TERRIER_ETC%\terrier.properties" -cp %LOCALCLASSPATH% uk.ac.gla.terrier.applications.desktop.DesktopTerrier %*
