...
REM ------------------------
REM -- Run InteractiveTerrier
REM ------------------------
java -Xmx64M -Dterrier.home="%TERRIER_HOME%" -Dterrier.etc="%TERRIER_ETC%" -Dterrier.setup="%TERRIER_ETC%\terrier.properties" -cp %LOCALCLASSPATH% uk.ac.gla.terrier.applications.InteractiveQuerying %*
