...
REM -- Run TRECSetup
REM ------------------------
java -Dterrier.home="%TERRIER_HOME%" -Dterrier.setup="%TERRIER_ETC%\terrier.properties" -cp %LOCALCLASSPATH% uk.ac.gla.terrier.applications.TRECSetup "%TERRIER_HOME%" %1%
